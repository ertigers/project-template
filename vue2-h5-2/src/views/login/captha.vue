<template>
  ...
  >
    ...
    <van-icon class="slide-verify-back-icon" name="arrow-left" @click="back" />
    <van-icon
  ...
  methods: {
    ...
    bindEvents() {
      document.addEventListener("mousemove", (e) => {
        ...
        const blockLeft = ((this.w - 40 - 5) / (this.w - 40)) * moveX;
        this.block.style.left = blockLeft + "px";
        // console.log(214, moveX, blockLeft);
      ...
      document.addEventListener("mouseup", (e) => {
        ...
        // console.log(203, e.clientX, this.originX);
    ...
    touchMoveEvent(e) {
      if (!this.isMouseDown) return false;
      const moveX = (e.changedTouches[0].pageX - this.originX) * 1.67;
    ...
    verify() {
      ...
      // console.log(237, this.blocky, left, stddev);
...
.slide-verify-back-icon:hover:before {
  /* transform: scale(1.2); */
  font-size: 26px;
  transition: all 0.2s;
}
